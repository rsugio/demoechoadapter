...
// Generated on: 2026.05.16 at 08:15:34 PM MSK 
//


package connectorsap;
...
public class ServiceRefHandlerType {
    ...
    protected connectorsap.String handlerName;
    ...
    protected List<connectorsap.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<connectorsap.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link connectorsap.String }
     *     
     */
    public connectorsap.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(connectorsap.String value) {
     ...
     * 
     */
    public List<connectorsap.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<connectorsap.String>();
        }
     ...
     * 
     */
    public List<connectorsap.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<connectorsap.String>();
        }

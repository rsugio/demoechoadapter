...
public class ServiceRefHandlerType {
    ...
    protected connector.String handlerName;
    ...
    protected List<connector.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<connector.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link connector.String }
     *     
     */
    public connector.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(connector.String value) {
     ...
     * 
     */
    public List<connector.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<connector.String>();
        }
     ...
     * 
     */
    public List<connector.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<connector.String>();
        }

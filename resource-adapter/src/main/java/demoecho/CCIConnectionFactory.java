...
public class CCIConnectionFactory implements XIConnectionFactory, Serializable, Referenceable {
    ...
    public Connection getConnection() throws ResourceException {
        ...
        Connection con = null;
        con = (Connection)this.cm.allocateConnection(this.mcf, (ConnectionRequestInfo)null);
    ...
    public Connection getConnection(ConnectionSpec spec) throws ResourceException {
        ...
        if (!(spec instanceof XIConnectionSpec)) {
            ...
            XIConnectionSpecImpl bb = (XIConnectionSpecImpl)spec;
            Connection con = null;
            ConnectionRequestInfo info = new CCIConnectionRequestInfo(bb.getChannelId());
